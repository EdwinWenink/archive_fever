...
1) My content now follows the [microformats2](http://microformats.org/wiki/microformats-2) format, which allows other members of the IndieWeb and related applications to find and parse my content and my online identity in a unified manner.

2) I can [POSSE](https://indieweb.org/POSSE) content to other sites if I want to, and feed responses back into my own website using [webmention.io](https://webmention.io).
